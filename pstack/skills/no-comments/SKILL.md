...
1. Spawn a generic subagent instructed to read [`references/comment-sicko.md`](references/comment-sicko.md). Pass the scope. Do not restate its rules.
   If the runtime has no subagent capability, read that prompt and perform its pass in the parent before continuing. Report that the review lacked independent fresh eyes.
